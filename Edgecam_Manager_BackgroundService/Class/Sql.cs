 ...
 * 					Update      - 14/06/2020 - 09:30 AM - Adicionado o método 'ExecutaMultiSql' - V3.3 Lançada.
 * 
 * 
...
internal class Sql : IDisposable
{
    ...
    public DataSet ExecutaMultiSql(String ComandoSql, Dictionary<String, Object> DicDados = null)
    {
        //SqlConnection cn = null;
