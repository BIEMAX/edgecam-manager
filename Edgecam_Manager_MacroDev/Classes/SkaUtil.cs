 ...
 *                  Update      - 15/12/2016 - 2:54 PM - Adicionado novo método para salvar var dados em um arq ini
 *                                              existente - V1.2 Lançada
 ...
 *                  Update      - 16/12/2016 - 8:58 PM - Adicionado ao método 'InsereDadosConfig' a opção de adicionar os
 *                                              comentários - V1.5
 ...
 *                  Update      - 23/03/2017 - 08:45 AM - Alterado o método de 'public void LeArquivosPasta' para
 *                                              'public List<string>' - V1.9 Lançada.
 ...
 *                  Update      - 17/08/2017 - 02:45 AM - Adicionado novos métodos 'BuscaDiretorio', 'BuscaArquivos', 
 *                                              'BuscaArquivo' - V2.6 Lançada
 *					Update 		- 21/08/2017 - 02:17 PM - Renomeado o método de 'VerifyNullValues' para 'IsObjectNull' - 
 *												V2.7 Lançada
...
/// </summary>
internal class SkaUtil
{

    #region Variáveis privadas

    protected String mMyComputer = Environment.MachineName;
    protected String mCurrentUser = Environment.UserName;
    protected String mMyDocuments = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments);
    protected String mDesktop = Environment.GetFolderPath(Environment.SpecialFolder.Desktop);
    ...
    /// </summary>
    /// <param name="frm">Sugestão: passar como parâmetro 'this'.</param>
