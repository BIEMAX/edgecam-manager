...
{
    internal partial class FrmConfig_CamposImportar : Form
    {

        #region Variáveis globais

        private CampoImportar mCampo;

        #endregion

        #region Instância dos objetos da classe

        public FrmConfig_CamposImportar()
        {
            InitializeComponent();
        ...
        public FrmConfig_CamposImportar(CampoImportar Campo)
        {
            InitializeComponent();
        ...
        private void InicializaValoresDefault()
        {
            ...
            DataTable dt = Objects.CnnBancoEcMgr.ExecutaSql(Consultas_EcMgr.CONSULTA_CAMPOS_CONFIGURADOS_IMPORTACAO);
        ...
        private void SalvaColunaImportar()
        {
            if (mCampo != null)
            {
                ...
                Objects.CnnBancoEcMgr.ExecutaSql(Consultas_EcMgr.ATUALIZA_CAMPO_IMPORTACAO, dic);
                Objects.CadastraNovoLog(false, String.Format("Campo '{0}' para importação foi atualizado", mCampo.NomeCampo), "FrmConfig_CamposImportar", "btnSalva_Click", "Atualização de campos", "Consultas_EcMgr.ATUALIZA_CAMPO_IMPORTACAO", e_TipoErroEx.Informacao);
            ...
            else
            {
                if (ValidaAntesDeSalvar())
                {
                    ...
                    Objects.CnnBancoEcMgr.ExecutaSql(Consultas_EcMgr.CADASTRA_NOVO_CAMPO_IMPORTAR, dic);
                    Objects.CadastraNovoLog(false, String.Format("Usuário '{0}' adicionou o campo '{1}' para importação de ordens", Objects.UsuarioAtual.Login, cbColunas.SelectedItem.ToString()), "FrmConfig_CamposImportar", "btnSalva_Click", "<None>", "Consultas_EcMgr.CADASTRA_NOVO_CAMPO_IMPORTAR", e_TipoErroEx.Aviso);
        ...
        private void btnSalva_Click(object sender, EventArgs e)
        {
            ...
            {
                Objects.CadastraNovoLog(true, "Erro ao adicionar campo para importação", "FrmConfig_CamposImportar", "btnSalva_Click", "<None>", "Consultas_EcMgr.CADASTRA_NOVO_CAMPO_IMPORTAR", e_TipoErroEx.Erro, ex);
            }
        }
