 ...
 * 
 * 
 *                  SkaXmlConfig - Classe com métodos para criação de um arquivo XML de configuração
 * 
 * 
...
internal class SkaXmlConfig
{
    ...
    public SkaXmlConfig(String NomeArqConfig)
    {
        try
        {
        ...
        {
            throw new Exception("Não foi possível instanciar o objeto na classe 'SkaXmlConfig'. Motivo do erro: " + ex.Message, ex);
        }
    }
    ...
    //    //TODO: 'SkaXmlConfig.cs' investigar a possibilidade do método 'SaveNewXmlFileConfig'
    //    /// <summary>
